...
*The Portfolio Tracker is set up to automatically record values for 8 assets (5 Stocks, 1 Bonds ETF, 1 Commodities ETF and 1 Cash) which can be adjusted to any chosen assets available on Google Finance, to add more see below.**
