...
*The Portfolio Tracker is set up to automatically record values for 8 assets, to add more assets follow the instructions and copy the examples in the template document.*
