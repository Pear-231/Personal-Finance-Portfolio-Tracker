...
*The Portfolio Tracker is set up to automatically record values for 8 assets which can be adjusted to any chosen assets available on Google Finance, to add more see below.**
...
2) Using the 'Portfolio' Sheet: adding and removing assets.
  ...
  *'Portfolio' Sheet: Current Assets*
  ...
  - Cells in the columns: 'Ticker', 'Quantity', 'Date of First Holding', 'Purchase Price Per Share', 'Purchase Price (£), 'Interest, Dividends and Distributions', and the asset name require manual input of data relevant to chosen assets. The 5 Stocks, 1 Bonds ETF, 1 Commodities ETF and Cash are example assets*, these are to be replaced with chosen assets.
